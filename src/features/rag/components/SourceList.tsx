                ...
                return (
                  ...
                  >
                    {isSafeUrl ? (
                      ...
                      <div className="flex items-start gap-2.5 rounded-lg border border-border-default bg-bg-surface p-3 opacity-80">
                        <span className="text-base leading-none mt-0.5">
                          {TYPE_ICON[source.type] ?? '📎'}
                        </span>
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-xs text-text-muted mt-1">Blocked unsafe source URL</p>
                        </div>
                      </div>
                    )}
                  </div>
